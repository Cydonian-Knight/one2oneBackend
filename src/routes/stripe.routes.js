...
router.post('/create-checkout', async (req, res) => {
    ...
    try {
        const session = await stripe.checkout.sessions.create({
            ...
            success_url: `${process.env.FRONTEND_URL}/chat/settings/payment?checkout=success&plan=${plan}`,
            cancel_url: `${process.env.FRONTEND_URL}/chat/settings/payment?checkout=cancelled`,
